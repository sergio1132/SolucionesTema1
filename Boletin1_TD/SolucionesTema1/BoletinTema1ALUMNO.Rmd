...
1.  La función **library** sin argumentos abre una ventana y muestra las librerías que han sido instaladas.
...
2.  En las transparencias del tema 1 se citan los primeros pasos a seguir cuando se analiza un nuevo conjunto de datos.
