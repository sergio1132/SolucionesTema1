...
diferentesA
#Son 7.
#Son "Dipliodocus" ,"Potar monkey","Triceratops",Brachiosaurus","Mole" ,"Artic fox","Artic ground squirrel".
```
...
#Presentan un compartimiento bastante parecido.
#Sí porque las muestras se encuentran dentro de las las líneas discontinuas.
```
